...
![](../docs/develop/%7BuseBaseUrl\(%22img/pos-using-metamask/deposit.png%22\)%7D)
...
![](../docs/develop/%7BuseBaseUrl\(%22img/pos-using-metamask/burn.png%22\)%7D)
...
The _**withdrawExit**_ function in PoS bridge involves block proof generation by querying the child chain multiple times and hence it may take 4-5 seconds for Metamask to popup as it consumes time to build the transaction object.
...
You can also use the _**withdrawExitFaster**_ method which can be used to exit the withdraw process faster. For more details please visit this [guide](https://maticnetwork.github.io/matic.js/docs/pos/erc20/withdraw-exit-faster/)

![](../docs/develop/%7BuseBaseUrl\(%22img/pos-using-metamask/exit.png%22\)%7D)
